        ...
        <AuthLayout title="Govt. of India" subtitle="CivicOS National — Citizen Registration">
            ...
            {step === 'input' ? (
                <div className="space-y-6">
                    <div>
                        <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 px-1">Register via Mobile</label>
                    ...
                    <p className="text-center text-xs font-bold text-slate-400">
                        Already have an account? <a href="/auth/login" className="text-gov-blue hover:underline font-black">Log in here</a>
                    </p>
                </div>
            ) : (
                <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                    ...
                    <button 
                        ...
                        className="w-full py-5 bg-gov-blue text-white font-black rounded-2xl shadow-xl shadow-gov-blue/20 hover:shadow-2xl transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                        {isLoading ? <RefreshCw className="w-5 h-5 animate-spin" /> : "Verify & Signup"}
                    </button>
