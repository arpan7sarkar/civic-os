...
export const env = {
    ...
    APPWRITE_PROJECT_ID: (typeof window !== 'undefined' ? process.env.NEXT_PUBLIC_APPWRITE_PROJECT_ID : (process.env.NEXT_PUBLIC_APPWRITE_PROJECT_ID || process.env.APPWRITE_PROJECT_ID)) || '',
